...
class OCRFileUploadView(APIView):
    ...
    @extend_schema(
        request={
            "multipart/form-data": PDFUploadSerializer
        },
        responses={
            200: OpenApiResponse(
                response={
                ...
                history=[
                    ...
                    },
                    {
                        ...
                        "parts": [
                            ...
                            helado
                            si tienes alguna alergia o intolerancia ,
                            por favor com ntaselo a nuestro personal
                            é
